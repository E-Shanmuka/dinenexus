      ...
      <div class="inner-wrapper">
        ...
        <section role="main" class="content-body">
          ...
          <section>
                ...
                if (isset($_POST['save'])) {
                  # code...
                  $sql = "UPDATE `restaurant_info` SET `restaurent_name`='".$_POST['fullname']."',`type`='".$_POST['type']."',`email`='".$_POST['email']."',`phone`='".$_POST['phone']."',`address`='".$_POST['address']."',`location`='".$_POST['area']."',`password`='".$_POST['password']."' WHERE `id`='$res_id'";
                  $cur = $con->query($sql);
                  if ($cur) {
                    # code...

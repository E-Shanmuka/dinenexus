            ...
            <div class="tab-content py-5" id="v-pills-tabContent">
              <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <div class="row">
                  <div class="col-lg-6">
                       <?php 
                      $sql2 = "SELECT * FROM `menu_item` WHERE food_type = 'Fast Food' LIMIT 3";
                  ...
                  <div class="col-lg-6">
                    <?php 
                      $sql2 = "SELECT * FROM `menu_item` WHERE food_type = 'Fast Food' LIMIT 3, 3";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
     ...
     <!--                <div class="menus d-flex ftco-animate">
              ...
              <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <?php 
                      $sql2 = "SELECT * FROM `menu_item` WHERE food_type = 'Dessert' LIMIT 3";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
                  ...
                  <div class="col-lg-6">
                  <?php 
                      $sql2 = "SELECT * FROM `menu_item` WHERE food_type = 'Dessert' LIMIT 3 , 3";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
              ...
              <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                <div class="row">
                  <div class="col-lg-6">
                            <?php 
                      $sql2 = "SELECT * FROM `menu_item` WHERE food_type = 'Drink' LIMIT 3 , 3";
                      $result2 = $con->query($sql2);
                      foreach ($result2 as $r2) {
                    ?>
                    <div class="menus d-flex ftco-animate">
